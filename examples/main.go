...
//go:generate go run ../cmd/kelpie generate --source-file main.go --package github.com/adamconnelly/kelpie/examples --interfaces Maths
type Maths interface {
	Add(a, b int) int
	ParseInt(input string) (int, error)
}

//go:generate go run ../cmd/kelpie generate --source-file main.go --package github.com/adamconnelly/kelpie/examples --interfaces EmailService
